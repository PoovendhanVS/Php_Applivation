...
<body>
  ...
  <div class="container-fluid mt-5">
    <center>
      <a href="sign_up.php"><button class="btn btn-success" style="float:right">Add</button></a>
      <h3>USER LISTS</h3>
    </center>
    <?php
    include 'users_list_link.php';
    ?>
  </div>
  ...
  <script>
    function confirmDelete(id) {
            ...
            if (result) {
                window.location.href = "user_id_delete.php?id=" + id;
            }
        }
